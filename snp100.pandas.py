...
# Load the dataset
df = pd.read_csv("C:/Users/Admin/Downloads/sp100.csv.csv")
...
sector_stats.plot(kind="barh",figsize=(10,6),
                  title="Sector-wise Avg Price and EPS")
